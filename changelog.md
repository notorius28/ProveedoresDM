...
- Corregidos los procesadores para evitar el error "Must have equal len keys and value when setting with an iterable" en el paso que trata de extraer ediciones especiales de vínilo en el título

## Dependecias

- Actualizado Streamlit a la versión 1.50
- Añadidos más ficheros a .gitignore
...
- Para el proveedor 17, se permite el procesamiento del fichero tanto para las pestañas que incluya la columna "Pedido" como las que no la incluyan. La columna adicional debe tener exactamente ese nombre.

## [1.0.39] 2026/03/03

## Novedades

- Para todos los proveedores, se eliminan espacios en blanco al final del campo Formato, que provocaba que no se invluyeran  algunas referencias en los ficheros de salida

## [1.0.38] 2025/11/26

## Novedades

- Actualizado el modelo de datos para la plantilla del Prov. 42 (Fondo)

## [1.0.37] 2025/11/09

## Novedades

- Actualizado el modelo de datos para la plantilla del Prov. 48 (Prelanzamientos)
...
- Modificado el diseño de campos de "Proveedor 42 fondo" a: 

'Código de Barras', 'Autor', 'Título', 'Pop-Classic', 'Sello', 'Formato', 'Component units', 'Fecha Lanzamiento', 'Price code', 'Precio Compra','Av. Stock'

## [1.0.32] 2025/04/20

## Correcciones

- Se deshace el último cambio en el "Proveedor 42 fondo" para quitar la columna "pedido" a la plantilla, ya que se ha vuelto al formato anterior por parte del proveedor

## [1.0.31] 2025/04/15

## Correcciones

- Se actualiza el "Proveedor 42 fondo" para añadir la columna "pedido" a la plantilla y se elimina del procesador la configuración alternativa que incluía el genero en el fichero del proveedor
